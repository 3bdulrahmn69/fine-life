  ...
  return (
    <Dropdown>
      <DropdownTrigger
        ...
        className="flex items-center gap-2 bg-primary-button hover:bg-primary-button-hover text-primary-button-foreground px-4 py-2 rounded-lg transition-all duration-200 shadow-sm"
      >
